...
output "dataproc_cluster_name" {
  ...
  value       = google_dataproc_cluster.dataproc_cluster_dev.name
}
...
output "dataproc_master_instance" {
  description = "Nome da instância master do Dataproc"
  value       = "${google_dataproc_cluster.dataproc_cluster_dev.name}-m"
}
...
output "architecture_summary" {
  ...
  value = {
    ...
    analytics = {
      ...
      dataproc_cluster   = google_dataproc_cluster.dataproc_cluster_dev.name
